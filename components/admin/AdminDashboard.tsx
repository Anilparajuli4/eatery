...
export default function AdminDashboard() {
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-gray-200">
    ...
    const safeStats = {
        ...
        newMenuItems: stats?.newMenuItems || 0,
        weeklySales: Array.isArray(stats?.weeklySales) ? stats.weeklySales : [],
        topSellingItems: Array.isArray(stats?.topSellingItems) ? stats.topSellingItems : [],
        ...
        <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-green-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-black text-gray-800 mt-2">${safeStats.revenue.toFixed(2)}</p>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-blue-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-black text-gray-800 mt-2">{safeStats.totalOrders}</p>
                            <p className="text-blue-600 text-sm font-bold mt-2">{safeStats.pendingOrders} pending</p>
                        </div>
                        <div className="text-5xl">📦</div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-purple-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-black text-gray-800 mt-2">${safeStats.avgOrderValue.toFixed(2)}</p>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-orange-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-black text-gray-800 mt-2">{safeStats.menuItems}</p>
                            <p className="text-orange-600 text-sm font-bold mt-2">{safeStats.newMenuItems} new this month</p>
                        </div>
                        <div className="text-5xl">🍔</div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <div className="space-y-4">
                        {safeStats.weeklySales.length > 0 ? (
                            safeStats.weeklySales.map((item: any) => {
                                // simplistic max value for bar scaling
                                const max = Math.max(...safeStats.weeklySales.map((s: any) => s.amount), 100);
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <div className="space-y-4">
                        {safeStats.topSellingItems.length > 0 ? (
                            safeStats.topSellingItems.map((item: any, index: number) => (
                            ...
                            <p className="text-gray-500 text-center py-4">No best sellers yet</p>
                        )}
                    </div>
                </div>
            </div>
